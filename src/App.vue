<template>
  <div id="app">
    <!-- <div style="z-index: 99999;" id="nav">
    ...
    <!-- 导航栏 -->
     <log_nav
          ...
          v-show="scrolltopA<100?true:false"
          :home_hide="home_hide"
          :windowWidth="windowWidth"
        ></log_nav>
        <log_nav1
          v-show="scrollStep<0?true:false"
          v-if="scrolltopA<100?false:true"
          @myhide="home_hide_byvalue"
          :home_hide="home_hide"
...
import my_nav from "./components/my-nav.vue"
...
export default {
  ...
  data(){
    return{
      // windowWidthA: document.documentElement.clientWidth, //实时屏幕宽度
      // windowHeightA: document.documentElement.clientHeight, //实时屏幕高度
         rocketshow: false,//火箭的显示隐藏
      home_hide:false,
      rocketshow:false,
    }
...
mounted (){
    ...
    setTimeout(() => {
      ...
      return (() => {
        window.fullWidth = document.documentElement.clientWidth;
         this.$store.commit('setWindowWidth', window.fullWidth);
      })();
    };
    }, 1000);
   //滚动条距离添加
  ...
  ...mapState(['windowWidth','scrollStep','scrolltopA'])
  },
  methods: {
    //火箭控制回到顶部
      hh() {
    ...
    //测试从vuex获取屏幕宽度
   ...mapMutations(['getWindowWidth','setWindowWidth']),
    ...
    watchScroll() {
      ...
      let scrollTop =
        ...
        window.pageYOffset;
      // 滚动条滚动的距离   
       this.$store.state.scrollStep = scrollTop - this.$store.state.scrolltopA;
      // 更新——滚动前，滚动条距文档顶部的距离
      this.$store.state.scrolltopA = scrollTop;
        if (this.$store.state.scrolltopA> 200) {
